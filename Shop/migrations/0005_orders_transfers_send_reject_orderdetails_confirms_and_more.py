# Generated by Django 4.1.6 on 2023-02-24 18:43
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Shop', '0004_rename_categories_productstype'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='Shop.customers')),
            ],
        ),
        migrations.CreateModel(
            name='Transfers',
            fields=[
                ...
                ('order', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='Shop.orders')),
            ],
        ),
        migrations.CreateModel(
            name='Send',
            fields=[
                ...
                ('comment', models.CharField(default='', max_length=200)),
                ('employee', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='Shop.employees')),
                ('order', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='Shop.orders')),
            ],
        ),
        migrations.CreateModel(
